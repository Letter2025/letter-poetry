...
> 计划状态：✅ 全部完成 ｜ 创建日期：2026-08-07 ｜ 完成日期：2026-08-07 ｜ 目标：通过 sitemap index + 分页子文件，让搜索引擎收录全部 47,629 个详情页
...
|---|---|
| 2026-08-07 | 创建计划 |
| 2026-08-07 | 完成：/sitemap.xml index + /sitemap-static.xml 精选 + /sitemap/1..5 详情分页（10,000/页，共 47,629）；robots 指向 index；验证通过 |
| 2026-08-07 | 备注：旧 /sitemap.xml 被 CDN 缓存（s-maxage 86400），新 index 约 1 天内自动生效；token 无 purge 权限，未强制刷新 |